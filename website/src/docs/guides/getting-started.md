...
description: Essential information to help you get set up with MihonOCR.
---
...
Essential information to help you get set up with MihonOCR.

## Installation guide

### Downloading MihonOCR

1. Visit our [download](/download/) page to get the latest version of **MihonOCR**.
2. After the download is complete, open the `.apk` file.
3. Proceed with the installation process.

### Adding sources

Once **MihonOCR** is installed on your device, you can bring your own content to read from various sources:
...
External repositories add additional sources to **MihonOCR**:
...
::: danger Caution
MihonOCR will not provide resources for any unofficial repositories. Beware that any third-party repositories or extensions will have full access to the app and may contain malware.
:::
...
::: danger Caution
MihonOCR will not provide resources for any unofficial extensions. Beware that any third-party repositories or extensions will have full access to the app and may contain malware.
:::
::::
